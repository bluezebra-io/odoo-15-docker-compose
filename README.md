...
``` bash
curl -s https://raw.githubusercontent.com/bluezebra-io/odoo-15-docker-compose/master/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://raw.githubusercontent.com/bluezebra-io/odoo-15-docker-compose/master/run.sh | sudo bash -s odoo-two 11015 21015
```
...
![odoo-15-welcome-docker](screenshots/odoo-15-welcome-screenshot.png)

![odoo-15-apps-docker](screenshots/odoo-15-apps-screenshot.png)

![odoo-15-sales](screenshots/odoo-15-sales-screen.png)

![odoo-15-form](screenshots/odoo-15-sales-form.png)
